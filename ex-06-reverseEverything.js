...
var reverseEverything = function(aBigArray){
  var backwardsArray = [];

  for(var i =0; i < aBigArray.length; i++){
    var amIbackwards = reverseObject(aBigArray[i])
    backwardsArray.unshift(amIbackwards);
  }
    return backwardsArray;
}

var reverseObject = function(someObj){

  var reversedObj = {}

  for(var newProp in someObj){
    var theSwitch = newProp
    var valueSwitch = someObj[newProp]
    reversedObj[valueSwitch] = theSwitch;
  }
  return  reversedObj;
}
