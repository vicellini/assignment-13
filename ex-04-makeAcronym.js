...
var makeAcronym = function(someString){
  var newAcro = ''
  var newArr = someString.split(' ')
  for(var i = 0; i < newArr.length; i++){
    var firstLetter = newArr[i];
    var eachFirstLetter = firstLetter.substr(0,1).toUpperCase()
    newAcro = newAcro + eachFirstLetter;
  }
  return newAcro
}
